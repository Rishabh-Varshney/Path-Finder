  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Path-Finder" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://github.com/Rishabh-Varshney/Path-Finder"
        />
      ...
      <footer className="footer">
        <p className="footer__author">Developed by RV</p>
        <a
          href="https://github.com/Rishabh-Varshney/Path-Finder"
          target="_blank"
